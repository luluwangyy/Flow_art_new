document.addEventListener('DOMContentLoaded', function () {
    document.getElementById('startSketch2').addEventListener('click', function() {
...
ctx.lineWidth = 0.3;// change the width of the stroke!!!
...
class Effect {
    constructor(canvas, ctx){
        ...
        this.flowField = [];
        this.debug = false;
        this.image = document.getElementById('moon2');
        this.init();
