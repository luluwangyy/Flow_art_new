document.addEventListener('DOMContentLoaded', function () {
    ...
    class Particle_ex3_up {
        ...
        update() {
            this.timer--;
            if (this.timer >= 1) {
                this.angle += (Math.random() - 0.5) * (this.angleCorrector*0.001); // Adjust the angleCorrector value as needed 0.001 straight line
        ...
        reset() {
            ...
            while (attempts < 30 && !resetSuccess) {
                ...
                if (this.effect.flowField[testIndex].alpha > 0) {
                    ...
                    this.color = `rgba(${this.red}, ${this.green}, ${this.blue}, 0.5)`;
                    resetSuccess = true;
                }
            }
            if (!resetSuccess) {
        ...
        /*
               //red
                ...
                //green
                if (flowFieldPixel.green > 100 && flowFieldPixel.green > flowFieldPixel.red * 1.5 && flowFieldPixel.green > flowFieldPixel.blue * 1.2) {
                    this.x = flowFieldPixel.x;
                    this.y = flowFieldPixel.y;
                    this.history = [{ x: this.x, y: this.y }];
                    this.timer = this.maxLength * 2;
                ...
                //blue
                if (flowFieldPixel.blue > 100 && flowFieldPixel.blue > flowFieldPixel.red * 1.5 && flowFieldPixel.blue > flowFieldPixel.red * 1.5) {
                    this.x = flowFieldPixel.x;
                    this.y = flowFieldPixel.y;
                    this.history = [{ x: this.x, y: this.y }];
                    this.timer = this.maxLength * 2;
            ...
            if (!resetSuccess) {
                ...
                this.color = `rgb(${this.red}, ${this.green}, ${this.blue},0)`;// the "0" is the alpha value, make it transparent, so no random color line will appear
            }
    ...
    class Effect_ex3_up {
        ...
        init() {
            ...
            for (let i = 0; i < this.numberOfParticles; i++) {
                this.particles.push(new Particle_ex3_up(this));
            }
