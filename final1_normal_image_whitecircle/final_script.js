...
ctx.lineWidth = 0.4;// change the width of the stroke!!!
...
class Particle {
    constructor(effect){
        ...
        this.maxLength = 200//Math.floor(Math.random() * 60+50);//can change (Math.random() * 60+50)
