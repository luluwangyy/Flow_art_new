...
function submitLayer(layer) {
    console.log(`submitLayer called with layer: ${layer}`); // Debugging log
    if (layer === 0) {
    ...
    if (currentLayer < layer) {
        ...
        console.log(`Submitting layer ${layer} with input: ${textInput}`); // Debugging log
        ...
        console.log('Layer already processed'); // Debugging log
    }
}

function pauseEffect() {
    if (!animationPaused) {
        console.log('Pausing animation'); // Debugging log
...
function takeScreenshot() {
    ...
    console.log('Screenshot taken'); // Debugging log
}
